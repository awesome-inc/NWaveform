...
namespace NWaveform.App
{
    internal class StreamingModule : Module
    {
        protected override void Load(ContainerBuilder builder)
        {
            ...
            builder.Register(c => RegisterChannel(c, new Uri("channel://2/"), TimeSpan.FromSeconds(20))).As<IStreamingAudioChannel>();
            builder.Register(c => RegisterChannel(c, new Uri("channel://3/"), TimeSpan.FromSeconds(33))).As<IStreamingAudioChannel>();
            builder.Register(c => RegisterChannel(c, new Uri("channel://4/"), TimeSpan.FromMinutes(1))).As<IStreamingAudioChannel>();
